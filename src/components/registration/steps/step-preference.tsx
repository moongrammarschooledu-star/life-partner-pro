...
export function StepPreference({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <p className="mb-3 text-sm font-medium">{t("agePreference")}</p>
      ...
      <div>
        <p className="mb-3 text-sm font-medium">{t("locationPreference")}</p>
        <div className="grid gap-4 sm:grid-cols-2">
      ...
      <OptionalSection>
        <div className="space-y-6">
          ...
          <div>
            <p className="mb-3 text-sm font-medium">{t("educationPreference")}</p>
            <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <p className="mb-3 text-sm font-medium">{t("professionPreference")}</p>
            <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <p className="mb-3 text-sm font-medium">
              🔒 {t("incomePreference")} — {t("adminOnlyIncome")}
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <p className="mb-3 text-sm font-medium">{t("heightPreference")}</p>
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label={t("minHeight")} htmlFor="minHeightCm">
                <HeightSelect id="minHeightCm" value={data.minHeightCm} onChange={(v) => onChange("minHeightCm", v)} />
              </Field>
              <Field label={t("maxHeight")} htmlFor="maxHeightCm">
                <HeightSelect id="maxHeightCm" value={data.maxHeightCm} onChange={(v) => onChange("maxHeightCm", v)} />
              </Field>
            </div>
          </div>

          <div>
            <p className="mb-3 text-sm font-medium">{t("familyPreference")}</p>
            <div className="grid gap-4 sm:grid-cols-2">

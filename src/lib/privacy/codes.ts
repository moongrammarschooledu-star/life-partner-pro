...
// LPP-REF- codes (STEP 14), and LPP-REL-/LPP-BKP-/LPP-ALT- codes (STEP 15) — mirrors src/lib/case-code.ts's exact
// atomic-upsert pattern with a reusable key instead of many near-identical
// single-purpose tables.
export type SequencePrefix = "DEL" | "PRIV" | "PAY" | "SUB" | "ORD" | "INV" | "DISC" | "PKG" | "REF" | "REL" | "BKP" | "ALT";

...
// Verbatim extraction of the pre-STEP-11 dashboard route body (no logic
// changes) — SUPER_ADMIN/ADMIN keep byte-identical responses. STAFF gets a
// different, reduced payload instead (see staff-dashboard.ts); the route
// itself just branches on role now.
...
export async function computeFullDashboard(period: string) {
